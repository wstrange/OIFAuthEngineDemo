...
public class ObjectFactory {
    ...
    private final static QName _AuthenticateResponse_QNAME = new QName("http://authsvc/", "authenticateResponse");
    private final static QName _Authenticate_QNAME = new QName("http://authsvc/", "authenticate");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://authsvc/", name = "authenticateResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://authsvc/", name = "authenticate")
